...
import youtubecheckin.core.com.akdeniz.googleplaycrawler.GooglePlay.AndroidBuildProto;
import youtubecheckin.core.com.akdeniz.googleplaycrawler.GooglePlay.AndroidCheckinProto;
import youtubecheckin.core.com.akdeniz.googleplaycrawler.GooglePlay.AndroidCheckinRequest;
import youtubecheckin.core.com.akdeniz.googleplaycrawler.GooglePlay.DeviceConfigurationProto;
import youtubecheckin.core.com.akdeniz.googleplaycrawler.misc.Base64;
import youtubecheckin.core.com.akdeniz.googleplaycrawler.misc.DummyX509TrustManager;
...
public class Utils {
  ...
  public static final String GOOGLE_PUBLIC_KEY = "AAAAgMom/1a/v0lblO2Ubrt60J2gcuXSljGFQXgcyZWveWLEwo6prwgi3"
  ...
  public static youtubecheckin.core.com.akdeniz.googleplaycrawler.GooglePlay.DeviceConfigurationProto getDeviceConfigurationProto() {
    return youtubecheckin.core.com.akdeniz.googleplaycrawler.GooglePlay.DeviceConfigurationProto
        .newBuilder()
        .setTouchScreen(3)
        .setKeyboard(1)
        .setNavigation(1)
