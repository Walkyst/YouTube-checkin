...
class Identity {
  ...
  private static final String CONTINUE_AUTH_URL = "https://accounts.google.com/o/android/auth?hl=en_en&xoauth_display_name=Android+Login+Service&source=Android+Login";
  private static final String LOGIN_URL = "https://android.googleapis.com/auth";
        ...
        for (NameValuePair pair : pairs) {
          if (pair.getName().contains("plt")) {
            URI uri = new URIBuilder(CONTINUE_URL)
                ...
                .addParameter("continue", CONTINUE_AUTH_URL)
                .addParameter("sarp", "1")
                .addParameter("scc", "1")
